...
public class InterpretDrawingFile {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		double [] polygonX = {parameterOne,parameterThree,parameterFive};
		double [] polygonY = {parameterTwo,parameterFour,parameterSix};
		...
		if (isFilled) {
			if(shapeType.equals("rectangle")) {
				...
				StdDraw.filledPolygon(polygonX,polygonY);
